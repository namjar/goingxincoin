...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // Gongxincoin is not connected
...
// Note: a lot of field are commented below. They are yet to be ported from bitcoin 0.8. This is something like a TODO list.
